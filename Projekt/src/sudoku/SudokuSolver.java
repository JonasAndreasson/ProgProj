...
public interface SudokuSolver {
	...
	/**
	 * Kollar om siffran number kan sättas i raden row och kolumnen col, om det
	 * inte går enligt spelreglerna returneras false
	 * 
	 * @throws IllegalArgumentException if number is outside [1..9] or row or col is
	 *                                  outside [0..8]
	 */
...
/*
 * TBD: Skriva javadoc-kommentarer (Påbörjat, kommentaren till setNumber är
 * klar.) Kommentarerna ska vara på ett språk (gärna engelska, annars
 * svenska) och följa konventionen för javadoc-kommentarer.
 */
